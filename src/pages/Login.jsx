    ...
    <>
      ...
      <section className='mx-4 sm:mx-auto mt-10 sm:mt-20 max-w-2xl h-2/4 flex flex-col items-center justify-center p-7 sm:shadow-2xl sm:rounded-lg text-center'>
        ...
        <form>
          ...
          <button onClick={onLogin} className='btn btn-outline btn-secondary capitalize text-2xl w-full my-3'>Login</button>
          <button onClick={handleDemoLogin} className='btn  btn-secondary capitalize text-2xl w-full my-3'>demo Login</button>
